...
This guide assumes that you've completed the steps for your operating system in [Installing the AWS SAM CLI](serverless-sam-cli-install.md), including:
...
If you see `{"message": "hello world"}` after executing the `curl` command, you've successfully deployed your serverless application to AWS, and you're calling your live Lambda function\. Otherwise, see the [Troubleshooting](#serverless-getting-started-hello-world-troubleshooting) section later in this tutorial\.
...
### AWS SAM CLI error: "Running AWS SAM projects locally requires Docker\. Have you got it installed?"<a name="serverless-getting-started-hello-world-troubleshooting-docker"></a>
...
To help you get started, you can download any of the example applications from the [AWS Serverless Application Repository Examples](https://github.com/aws-samples/serverless-app-examples) repository on GitHub\.
